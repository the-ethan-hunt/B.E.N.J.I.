...
* Gmail(Get your unread gmails that include sender_id,date,subject and meassage_bobdy)
...
*You can get a details and list of all unread mails by just saying "get unread mail" (Before using this command for enable the gmail api please go to  
 " https://developers.google.com/gmail/api/quickstart/python " and click on the enable the gmail api and create new project, give project name and click on next download client configuration file and name it Gmail_API.json and place it on B.E.N.J.I.\windows )
